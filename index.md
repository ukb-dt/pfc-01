...
* **Glucose utilization** in the PFC
* **White-matter conduction velocity**
* **Dopaminergic tone**
* **Working-memory bandwidth**
* **Inhibitory control (GABAergic)**
...
* PFC volume declines (~5% per decade after 40)
* Inhibition drops faster than language ability
* Semantic memory is preserved
* Social self-monitoring becomes patchier
...
* **Less social risk**
* **More crystallized values**
* **Fewer incentives to self-censor**
* **A lifetime of reinforcement that bluntness has consequences they can live with**

This is “value layer” externalization: the world stops punishing certain behaviors, so the model stops updating.

In your framework:

**external loss signal → collapses**
So the agent stops optimizing for “social smoothness” as a reward.
